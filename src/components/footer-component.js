...
export class FooterComponent extends LitElement {
    ...
    static styles = css`
        ...
        .export-btn.markdown:hover {
            background: linear-gradient(135deg, #059669 20%, var(--accent-emerald) 100%);
    ...
    handleExportMarkdown() {
        ...
        try {
            const title = this._parseABCField('T') || 'Untitled Composition';
            const composer = this._parseABCField('C') || 'Traditional / Unknown';
            const key = this._parseABCField('K') || 'C';
            const meter = this._parseABCField('M') || '4/4';
            const noteLength = this._parseABCField('L') || '1/4';
            const tempo = this._parseABCField('Q') || '1/4=120';
...
- **Default Note Length:** ${noteLength}
- **Tempo:** ${tempo}
        ...
        return html`
            <footer class="footer-container">
                ...
                <div class="export-area">
                    <button class="export-btn markdown" @click="${this.handleExportMarkdown}" title="Download Composition as Markdown File">
                        📝 MD Stave
                    </button>
